...
{
    public partial class NWConsole_48_DABContext : DbContext
    {
        public NWConsole_48_DABContext()
        {
        }

        public NWConsole_48_DABContext(DbContextOptions<NWConsole_48_DABContext> options)
            : base(options)
        {
        }
